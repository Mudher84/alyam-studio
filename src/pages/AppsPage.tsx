...
export default function AppsPage() {
  ...
  const filteredItems = projects.filter(item => {
    if (item.category !== 'Apps') return false;
  ...
  return (
    <div className="min-h-screen bg-[#F6F2EB] text-[#1A1815] flex flex-col selection:bg-amber-200" dir={isRTL ? 'rtl' : 'ltr'}>
      <SEO title={t('apps.title')} description={t('apps.description')} />
      <Navbar />
      ...
      <main className="flex-1 pt-28 sm:pt-32 pb-24 px-4 sm:px-6 md:px-12 lg:px-24">
        ...
        {/* Random Apps Showcase Top Section - Dashboard Screen Variant */}
        <div className="max-w-7xl mx-auto">
          <RandomTopSlider 
            category="Apps" 
            variant="dashboard"
            badgeText={t('apps.sliderBadge')}
            headline={t('apps.sliderHeadline')}
          />
        </div>
            ...
            return (
              ...
              >
                <div className="aspect-[16/9] bg-[#EAE2D5] rounded-xl overflow-hidden relative mb-4 shadow-sm border border-[#E0D7C9]/60">
                  ...
                  {/* Overlay gradient for a premium subtle feel */}
